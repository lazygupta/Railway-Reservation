...
public class UserProfile extends HttpServlet {
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		pw.println("<div class='tab'>" + "		<p1 class='menu'>" + "	Hello " + TrainUtil.getCurrentUserName(req)
				+ " ! Welcome to our new Railway Reservation System Website Website" + "		</p1>" + "	</div>");
		...
		pw.println("<div class='tab yellow'>Hey ! " + TrainUtil.getCurrentUserName(req)
				+ ",Welcome to Railway Reservation System Website<br/><br/>Here You can Edit,View Your Profile and change your PassWord.<br/>"
